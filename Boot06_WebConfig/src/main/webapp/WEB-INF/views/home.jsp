...
<body>
	<div class="container">
		...
		<ul>
			<li><a href="${pageContext.request.contextPath }/html/hello.html">html 페이지 가기</a></li>
			<%-- static 폴더에는 jsp 페이지를 위치 시킬 수 없다. --%>
			...
			<li><a class="nav-link" 
               href="${pageContext.request.contextPath}/file/uploadform">파일 업로드 데스트</a></li>
		</ul>
