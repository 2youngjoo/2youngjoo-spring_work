...
// Responsebody가 포함된 컨트롤러
@RestController
public class AndroidController {
	/*
	 * 	String type을 리턴하면 리턴된 String의 내용이 그대로 응답한다.
	 */
	...
	// Map type을 리턴하면 Map에 담긴 내용이 {} 형식의 json 문자열로 응답된다.
	// Android에서는 JSONObject 객체를 생성해서 추출
	...
	// List type을 리턴하면 List에 담긴 내용이 [] 형식의 json 문자열로 응답된다.
	// Android에서는 JSONArray 객체를 생성해서 추출
	...
	public List<CafeDto> list(){
		// 1page의 내용을 select 해오기 위한 CafeDto 객체를 준비
