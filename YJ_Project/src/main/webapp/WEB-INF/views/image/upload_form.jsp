...
<body>
	<div class="container">
		<h1>상품 등록 폼</h1>
      	...
      	<div class="mb-2">
         	...
         	<input class="form-control" type="text" name="caption" id="caption" placeholder="설명 입력...."/>
      	</div>
		<div class="mb-2">
			<label class="form-label" for="price">가격</label>
			<input class="form-control" type="text" name="price" id="price" placeholder="금액 입력...."/>
		</div>
		<select class="form-select mb-2" id="clothesize" name="clothesize">
	...
	<script>
		...
		document.querySelector("#submitBtn").addEventListener("click", ()=>{
			...
			const clothesize=document.querySelector("#clothesize").value;
			...
			data.append("clothesize", clothesize);
